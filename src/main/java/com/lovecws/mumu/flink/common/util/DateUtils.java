...
public class DateUtils {
     ...
     * @return
     */
    public static String getPartitionTable(Date date, String stragety) {
        String tableName = null;
        if ("day".equalsIgnoreCase(stragety)) {
            tableName = DateUtils.formatDate(date, "yyyyMMdd");
        } else if ("week".equalsIgnoreCase(stragety)) {
            tableName = DateUtils.getDateWeekStartStr(date, "yyyyMMdd");
        } else if ("month".equalsIgnoreCase(stragety)) {
            tableName = DateUtils.formatDate(date, "yyyyMM");
        } else if ("year".equalsIgnoreCase(stragety)) {
            tableName = DateUtils.formatDate(date, "yyyy");
        } else if ("hour".equalsIgnoreCase(stragety)) {
            tableName = DateUtils.formatDate(date, "yyyyMMddHH");
        }
        return tableName;
    }
     ...
     * @return
     */
    public static String getPartitionTableBegining(Date date, String stragety) {
        String day = null;
        if ("day".equalsIgnoreCase(stragety)) {
            day = DateUtils.formatDate(date, "yyyyMMdd000000");
        } else if ("week".equalsIgnoreCase(stragety)) {
            day = DateUtils.getDateWeekStartStr(date, "yyyyMMdd000000");
        } else if ("month".equalsIgnoreCase(stragety)) {
            day = DateUtils.formatDate(date, "yyyyMM01000000");
        } else if ("year".equalsIgnoreCase(stragety)) {
            day = DateUtils.formatDate(date, "yyyy0101000000");
        } else if ("hour".equalsIgnoreCase(stragety)) {
            day = DateUtils.formatDate(date, "yyyyMMddHH0000");
        }
        return day;
    }

    public static String getDateByStragety(Date date, String stragety) {
        String format = null;
        if ("day".equalsIgnoreCase(stragety)) {
     ...
     * @return
     */
    public static String getPartitionTableEnding(Date date, String stragety) {
        String day = null;
        if ("day".equalsIgnoreCase(stragety)) {
            day = DateUtils.formatDate(date, "yyyyMMdd") + "240000";
        } else if ("week".equalsIgnoreCase(stragety)) {
            day = DateUtils.getDateWeekEndStr(date) + "240000";
        } else if ("month".equalsIgnoreCase(stragety)) {
            day = DateUtils.formatDate(DateUtils.lastDayOfMonth(date), "yyyyMMdd") + "240000";
        } else if ("year".equalsIgnoreCase(stragety)) {
            day = DateUtils.formatDate(date, "yyyy") + "1231240000";
        } else if ("hour".equalsIgnoreCase(stragety)) {
            day = DateUtils.formatDate(date, "yyyyMMddHH") + "6000";
        }
        return day;
    }

    public static List<String> getDays(Date date, String stragety, int count) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            String day = null;
            if ("day".equalsIgnoreCase(stragety)) {
                day = DateUtils.formatDate(calendar.getTime(), "yyyyMMdd");
            } else if ("week".equalsIgnoreCase(stragety)) {
                day = DateUtils.getDateWeekStartStr(calendar.getTime(), "yyyyMMdd");
            } else if ("month".equalsIgnoreCase(stragety)) {
                day = DateUtils.formatDate(calendar.getTime(), "yyyyMM01");
            } else if ("year".equalsIgnoreCase(stragety)) {
                day = DateUtils.formatDate(calendar.getTime(), "yyyy0101");
            }
            days.add(day);
        }
        return days;
     ...
     * 根据缓存获取缓存时间
     *
     * @param expire 支持h、m、d、w等格式
     * @return
     */
    public static int getExpireTime(String expire) {
        int expireTime = 0;
        ...
        if (expire.endsWith("s")) {
            ...
            expireTime = timeCount * 7 * 60 * 60 * 24;
        } else {
            expireTime = timeCount;
        }
        return expireTime;
...
/*        System.out.println(getPartitionTable(new Date(), "hour"));
        System.out.println(getPartitionTableBegining(new Date(), "hour"));
        System.out.println(getPartitionTableEnding(new Date(), "hour"));

        List<String> week = getDays(null, "week", 7);
        System.out.println(week);

        System.out.println(lastDayOfYearMonth(new Date()).toLocaleString());*/
