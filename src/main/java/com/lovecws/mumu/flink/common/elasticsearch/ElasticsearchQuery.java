...
public class ElasticsearchQuery extends ElasticsearchBaseQuery {
    ...
    public ElasticsearchQuery(EsConfig esConfig, String indexNames, String typeName) {
        this(esConfig, null, indexNames, typeName);
    }

    public ElasticsearchQuery(EsConfig esConfig, ElasticsearchPool elasticsearchPool, String indexNames, String typeName) {
        super(esConfig, elasticsearchPool, indexNames.split(","), typeName);
    }
